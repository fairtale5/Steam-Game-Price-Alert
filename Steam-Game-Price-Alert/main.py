                        ...
                        if game_data and 'price_overview' in game_data:
                            ...
                            if mode_choice == "1":
                                ...
                                if should_post_sale(store_id, discount_percent):
                                    print(f"\n\033[1;31mDiscount changed! Current price: ${current_price:.2f} ({discount_percent}% off)\033[0m")
                                    send_discord_notification(
                                        game_name=game_name,
                                        current_price=current_price,
                                        discount_percent=discount_percent,
                                    ...
                                    print("\nDiscount unchanged. Skipping notification.")
                                else:
                                    print("\nNo discount. Skipping notification.")
